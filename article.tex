...
\bar{P}_{\mathrm{run}}\,t_{\mathrm{run}}$, and our conmparison metric, energy efficiency is calculated as as
$\varepsilon = T/\bar{P}_{\mathrm{run}}$ (tokens/J); the energy per token (J/tokens) is its
...
usability and descending FoM. Bold: best FoMfull per model.}
\label{tab:e0}
...
\toprule
\textbf{Model} & \textbf{Fan} & \textbf{$N_{\mathrm{act}}$} & \textbf{RAM} &
