...
throttling as a first-order factor in edge deployments, although theirs is
...
usability and descending FoM. Bold: best $\mathrm{FoM}_{\mathrm{full}}$ per model.}
\label{tab:e0}
...
Llama~3.2~1B to 1.6~tok/s. On a memory-bound
...
if only the FoM is considered, Q4\_0 and Q3\_K\_M are the best alternatives:
Q3\_K\_M attains the highest FoM in four of the six models and Q4\_0 in
Ministral-3B, and both outperform Q4\_K\_M in FoM in every model except
...
Q4\_K\_M offers the best balance: its FoM is close to the maximum, it is usable
...
respect to Q8\_0, offering the best balance between FoM and quality.
Q4\_0 and Q3\_K\_M reach the highest FoM and can substitute Q4\_K\_M when
...
memory-bound platform, with Q4\_K\_M as the best balance between FoM and
quality (Q4\_0 and Q3\_K\_M reach a higher FoM), whereas 8-bit and full-precision formats are
